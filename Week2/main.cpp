...
const Rational Rational::add(const Rational &B) const {
   ...
   numer = (numerator * B.denominator) + (denominator * B.numerator);
   denom = (denominator * B.denominator);
...
const Rational Rational::divide(const Rational &B) const {
   ...
   numer = numerator * B.denominator;
   denom = B.numerator * denominator;
